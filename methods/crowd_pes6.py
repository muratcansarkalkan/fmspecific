...
class CROWD_PES6(bpy.types.Operator):

    bl_label = "crowd_pes6"
    bl_idname = "object.crowdpes6"
    bl_description = "Separates crowd properly for PES6"
    ...
    def execute(self, context):
        ...
        texture_name_mapping = {".rwa0.png": "A", ".rwh0.png": "H"}
