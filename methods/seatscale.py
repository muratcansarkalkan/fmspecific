...
class SEAT_SCALE(bpy.types.Operator):
    bl_label = "Seat Scale"
    bl_idname = "object.seatscale"
    bl_description = "Scales seat UV maps based on seat number in texture"
    
    seat: bpy.props.IntProperty(
        name="Seat",
        description="Number of seats in texture",
        default=4,
        min=1,
        max=100
    )
